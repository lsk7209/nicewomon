...
import { Calendar, Clock, Moon, Lightbulb, Coffee } from "lucide-react";
                ...
                <ContentWithToc items={tocItems}>
                    <section id="summary" className="bg-white border border-blue-100 rounded-2xl p-6">
                        ...
                        <ul className="list-disc pl-5 text-gray-700 space-y-1">
                            <li>취침 2시간 전 조도 낮추기, 블루라이트 최소화</li>
                            <li>카페인 8~10시간 전 컷오프, 알코올·과식 피하기</li>
                            <li>샤워/족욕 후 체온 하강 30~60분 확보</li>
                            <li>수분은 취침 2시간 전부터 소량 유지</li>
                        </ul>
                    </section>
                    ...
                    <section id="routine" className="space-y-4">
                        ...
                        {steps.map((step) => (
                            <Card key={step} className="border border-blue-100">
                                <CardContent className="pt-5 text-sm text-gray-700">{step}</CardContent>
                            </Card>
                        ))}
                    </section>
                    ...
                    <section id="faq" className="space-y-3">
                        ...
                        <Card className="border border-blue-100">
                            <CardContent className="pt-5 space-y-2">
                                ...
                                <p className="text-gray-700 text-sm">침대에 오래 누워 있지 말고, 은은한 조명 아래 5~10분 호흡 후 다시 눕습니다.</p>
                            </CardContent>
                        </Card>
                        <Card className="border border-blue-100">
                            <CardContent className="pt-5 space-y-2">
                                <p className="font-semibold text-gray-900">카페인 시간 계산은?</p>
                                <p className="text-gray-700 text-sm">취침 8~10시간 전이 기본입니다. 민감하면 오후 1~2시 컷을 권장합니다.</p>
                            </CardContent>
                        </Card>
                    </section>
                </ContentWithToc>
