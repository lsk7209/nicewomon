...
import { Calendar, Clock, SunMedium, Moon, Activity } from "lucide-react";
...
export const metadata: Metadata = {
    ...
    description: "기상 후 30분 내 햇빛 노출, 점심 산책, 저녁 조도 관리로 서카디언 리듬을 안정시키는 방법을 안내합니다.",
    keywords: ["아침 햇빛", "수면 질", "서카디언 리듬", "교대근무 전환", "불면 개선"],
    ...
    return (
        <div className="bg-gradient-to-b from-amber-50 via-white to-amber-50 min-h-screen">
            <article className="container mx-auto px-4 py-16 md:py-24 max-w-4xl">
                ...
                <ContentWithToc>
                    <section id="summary" className="bg-amber-50 border border-amber-100 rounded-2xl p-6">
                        <h2 className="text-2xl font-bold text-gray-900 mb-3">핵심 요약</h2>
                        <ul className="space-y-2 text-gray-700">
                            <li>기상 30분 내 야외 빛 10~15분 → 멜라토닌 분해·코르티솔 리듬 정렬</li>
                            <li>점심 5~10분 산책 → 오후 졸림 감소, 야간 입면 지연 예방</li>
                            <li>취침 2시간 전 조도 50~100 lux → 멜라토닌 분비 보존</li>
                        </ul>
                    </section>
