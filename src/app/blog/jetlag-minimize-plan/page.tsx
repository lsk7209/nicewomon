...
import { Calendar, Clock, Plane, Sun, Bed } from "lucide-react";
...
export const metadata: Metadata = {
    ...
    description: "출발 전/도착 후 3일 플랜으로 빛 노출, 식사 시간, 수면 길이를 조정해 시차를 최소화하는 방법.",
    keywords: ["시차", "빛 노출", "수면 조정", "여행 피로", "제트랙"],
            ...
            <article className="container mx-auto px-4 py-16 md:py-24 max-w-4xl">
                ...
                <ContentWithToc items={tocItems}>
                    ...
                    <section id="timing" className="bg-purple-50 border border-purple-100 rounded-2xl p-6 space-y-3">
                        <h3 className="text-xl font-bold text-gray-900">빛·식사·수면 타이밍</h3>
                        <ul className="list-disc pl-5 text-gray-700 space-y-1">
                            <li>아침: 현지 시간 기준 20분 햇빛, 카페인은 아침/점심에만</li>
